...
<footer class="container-fluid text-center">
 <div class="row1">
    ...
    <div class="col-sm-6" style="background-color:lavender;"><span class="glyphicon glyphicon-envelope"> <b>mail</b>:public@pendrive.in</span> </div>
