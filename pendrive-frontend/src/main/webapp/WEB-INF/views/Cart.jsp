...
body {
	background-image: url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRoW45JrioW5MC6spo7S2XaoI6eUtLPsICJVX672utWYdBWRmtF");
...
<body>
	...
	<header>
		<center>
		<h1 style="font-family:monotype corsiva;"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRenn1dfnJbS8vjPLR6uhzbmB16jJ_FOYiMNjaI7GXO9NOM4aqT" height="77" width="77" style="font-family: monotype corsiva;" /><b>PenDrive</b></h1>
	</center>
		  ...
		  <thead>
			...
			<tbody>
				<tr ng-repeat = "items in cart.cartItems">
						...
						<td><button class="btn btn-danger btnAction" ng-click="removeItemFromCart(items.cartItemId)">
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
      ...
      */
      $scope.removeItemFromCart = function (cartItemId) {
         ...
         $http['delete']('http://localhost:8081/pendrive-frontend/categoryDropdown/productDisplay/usercart/cart/removeItem/'+cartItemId).success(function (data) {
     ...
     $scope.addItemToCart = function (id) {
         $http.put('http://localhost:8081/pendrive-frontend/usercart/cart/addItem/'+id).success(function (data) {
     ...
     $scope.refreshCartItems = function () {
         $http.get('http://localhost:8081/pendrive-frontend/categoryDropdown/productDisplay/usercart/cart/refreshCart/'+$scope.cartId).success(function (data) {
            $scope.cart=data;
         });
     };
     ...
     $scope.clearCartItems = function () {
     	$http['delete']('http://localhost:8081/pendrive-frontend/categoryDropdown/productDisplay/usercart/cart/clearCartItems/'+$scope.cartId).success(function (data)
     			{$scope.refreshCartItems()
     		});
     };
 });
