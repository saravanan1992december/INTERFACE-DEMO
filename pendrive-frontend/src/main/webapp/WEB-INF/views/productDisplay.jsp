...
<!-- Page Content -->
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <p class="lead">Pen Drive</p>
                <div class="list-group">
                    <a href="categoryDropdown/25" class="list-group-item">sandisk</a>
                    <a href="categoryDropdown/26" class="list-group-item">hp</a>
                    <a href="categoryDropdown/27" class="list-group-item">transcend</a>
            </div>
            </div>
   <div class="col-md-9">
...
<img src="${product.image}" class="img-responsive"  height="300px" width="300px" />
...
<a href="categoryback"><button type="button" class="btn btn-primary" >back to categories</button></a>
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
     ...
     $scope.removeItemFromCart = function (id) {
         $http.put('http://localhost:8081/pendrive-frontend/removeItem/'+id).success(function (data) {
     ...
     $scope.addItemToCart = function (id) {
         $http.put('http://localhost:8081/pendrive-frontend/categoryDropdown/productDisplay/usercart/cart/addItem/'+id).success(function (data) {
     ...
     $scope.refreshCartItems = function () {
         $http.get('http://localhost:8081/pendrive-frontend/refreshCart/'+$scope.cartId).success(function (data) {
            $scope.cart=data;
         });
     };
     ...
     $scope.clearCartItems = function () {
     	$http['delete']('http://localhost:8081/pendrive-frontend/clearCartItems/'+$scope.cartId).success(function (data)
     			{$scope.refreshCartItems()
     		});
     };
 });
