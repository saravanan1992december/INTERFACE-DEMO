...
<div  ng-app="addToCartApp"  ng-controller = "addToCartCtrl"  ng-init="retrieveCart('${cartId}')">
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
     ...
     $scope.removeItemFromCart = function (name) {
         $http.put('http://localhost:8081/pendrive-frontend/categoryDropdown/productDisplay/usercart/cart/removeItem/'+name).success(function (data) {
     ...
     $scope.addItemToCart = function (id) {
         $http['delete']('http://localhost:8081/pendrive-frontend/usercart/cart/addItem/'+id).success(function (data) {
